//TODO Enable on new flupke version
//package io.avaje.jex.flupke.core;
//
...
//import io.avaje.jex.http3.flupke.TestPair;
//
...
//      .routing(routing -> routing        .get("/uri/{param}", ctx -> ctx.text("uri:" + ctx.uri()))
